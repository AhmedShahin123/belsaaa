 ...
 * Generated for Laravel 6.9.0 on 2020-07-30 12:21:54.
 *
...
namespace BeSaah\Facades { 
    ...
    class WorkflowRegistry {
         ...
         * 
         *
         * @param \Symfony\Component\Workflow\SupportStrategyInterface $supportStrategy
         * @deprecated since Symfony 4.1, use addWorkflow() instead
         * @static 
         */ 
        public static function add($workflow, $supportStrategy)
        {
                        /** @var \Symfony\Component\Workflow\Registry $instance */
                        return $instance->add($workflow, $supportStrategy);
        }
         ...
         * @static 
         */ 
        public static function addWorkflow($workflow, $supportStrategy)
        {
                        /** @var \Symfony\Component\Workflow\Registry $instance */
                        return $instance->addWorkflow($workflow, $supportStrategy);
        }
         ...
         * @static 
         */ 
        public static function get($subject, $workflowName = null)
        {
                        /** @var \Symfony\Component\Workflow\Registry $instance */
                        return $instance->get($subject, $workflowName);
        }
...
namespace Kreait\Laravel\Firebase\Facades { 
    ...
    class FirebaseAuth {
         ...
         * @throws Exception\AuthException
         * @throws Exception\FirebaseException
         * @return \Generator|\Kreait\Firebase\UserRecord[] 
         * @static 
         */ 
         ...
         *
         * @param array|\Kreait\Firebase\Request\CreateUser $properties
         * @throws Exception\AuthException
         * @throws Exception\FirebaseException
         * @static 
         */ 
         ...
         *
         * @param \Kreait\Firebase\Uid|string $uid
         * @param array|\Kreait\Firebase\Request\UpdateUser $properties
         * @throws Exception\AuthException
         * @throws Exception\FirebaseException
         * @static 
         */ 
         ...
         * @codeCoverageIgnore 
         * @param \Kreait\Firebase\Uid|string $uid
         * @param \Kreait\Firebase\UriInterface|string|null $continueUrl
         * @throws UserNotFound
         * @throws Exception\AuthException
         * @throws Exception\FirebaseException
         * @static 
         */ 
        public static function sendEmailVerification($uid, $continueUrl = null, $locale = null)
        {
                        /** @var \Kreait\Firebase\Auth $instance */
                        return $instance->sendEmailVerification($uid, $continueUrl, $locale);
        }
         ...
         * @codeCoverageIgnore 
         * @param \Kreait\Firebase\Email|mixed $email
         * @param \Kreait\Firebase\UriInterface|string|null $continueUrl
         * @throws Exception\AuthException
         * @throws Exception\FirebaseException
         * @static 
         */ 
        public static function sendPasswordResetEmail($email, $continueUrl = null, $locale = null)
        {
                        /** @var \Kreait\Firebase\Auth $instance */
                        return $instance->sendPasswordResetEmail($email, $continueUrl, $locale);
        }
         ...
         *
         * @param \Kreait\Firebase\Email|string $email
         * @param \Kreait\Firebase\ActionCodeSettings|array|null $actionCodeSettings
         ...
         * @static 
         */ 
        public static function verifyIdToken($idToken, $checkIfRevoked = false, $allowTimeInconsistencies = null)
        {
                        /** @var \Kreait\Firebase\Auth $instance */
                        return $instance->verifyIdToken($idToken, $checkIfRevoked, $allowTimeInconsistencies);
        }
         ...
         * @throws Exception\AuthException
         * @throws Exception\FirebaseException
         * @return \Kreait\Firebase\UserRecord if the combination of email and password is correct
         * @static 
         */ 
        public static function verifyPassword($email, $password)
        {
                        /** @var \Kreait\Firebase\Auth $instance */
                        return $instance->verifyPassword($email, $password);
        }
         ...
         * @codeCoverageIgnore Logs in the user to Firebase by a provider's access token (like Google, Facebook, Twitter, etc),
         ...
         * @static 
         */ 
        public static function linkProviderThroughAccessToken($provider, $accessToken)
        {
                        /** @var \Kreait\Firebase\Auth $instance */
                        return $instance->linkProviderThroughAccessToken($provider, $accessToken);
        }
         ...
         * @codeCoverageIgnore Logs in the user to Firebase by a provider's ID token (like Google, Facebook, Twitter, etc),
         * if the authentication provider is enabled for the project.
         * 
         ...
         * @static 
         */ 
        public static function linkProviderThroughIdToken($provider, $idToken)
        {
                        /** @var \Kreait\Firebase\Auth $instance */
                        return $instance->linkProviderThroughIdToken($provider, $idToken);
        }
         ...
         * @static 
         */ 
        public static function signInWithIdpAccessToken($provider, $accessToken, $redirectUrl = null)
        {
                        /** @var \Kreait\Firebase\Auth $instance */
                        return $instance->signInWithIdpAccessToken($provider, $accessToken, $redirectUrl);
        }
    ...
    class FirebaseMessaging {
         ...
         * 
         *
         * @param array|\Kreait\Firebase\Message|mixed $message
         * @throws InvalidArgumentException
         ...
         *
         * @param array|\Kreait\Firebase\Message|mixed $message
         * @param \Kreait\Firebase\RegistrationToken[]|string[]|\Kreait\Firebase\RegistrationTokens $registrationTokens
         ...
         * @static 
         */ 
        public static function sendMulticast($message, $registrationTokens)
        {
                        /** @var \Kreait\Firebase\Messaging $instance */
                        return $instance->sendMulticast($message, $registrationTokens);
        }
        
        /**
         * 
         *
         * @param array[]|\Kreait\Firebase\Message[]|\Kreait\Firebase\Messages $messages
         * @throws InvalidArgumentException if the message is invalid
         * @throws MessagingException if the API request failed
         * @throws FirebaseException if something very unexpected happened (never :))
         * @static 
         */ 
        public static function sendAll($messages)
        {
                        /** @var \Kreait\Firebase\Messaging $instance */
                        return $instance->sendAll($messages);
        }
         ...
         * 
         *
         * @param string|\Kreait\Firebase\Topic $topic
         ...
         * @param \Kreait\Firebase\RegistrationToken|string $registrationToken
    ...
    class FirebaseRemoteConfig {
         ...
         *
         * @param \Kreait\Firebase\Template|array $template
         ...
         *
         * @param \Kreait\Firebase\VersionNumber|mixed $versionNumber
         ...
         * 
         *
         * @param \Kreait\Firebase\FindVersions|array $query
         * @return \Generator|\Kreait\Firebase\Version[] 
         * @static 
         */ 
    ...
    class FirebaseStorage {
         ...
         * @static 
         */ 
        public static function getFilesystem($bucketName = null)
        {
                        /** @var \Kreait\Firebase\Storage $instance */
                        return $instance->getFilesystem($bucketName);
        }
...
namespace  { 
    ...
    class WorkflowRegistry extends \BeSaah\Facades\WorkflowRegistry {}
