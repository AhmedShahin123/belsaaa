...
Route::group([
    ...
    Route::group(['namespace' => 'User'], function () {
        ...
        Route::group(['prefix' => 'user/{user}'], function () {
            ...
            // Password
            Route::any('password/change', [UserPasswordController::class, 'edit'])->name('user.change-password');
            Route::put('password/update', [UserPasswordController::class, 'update'])->name('user.change-password.post');
