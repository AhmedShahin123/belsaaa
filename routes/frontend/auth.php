...
use App\Http\Controllers\Frontend\Auth\PhoneVerificationController;
...
Route::group(['namespace' => 'Auth', 'as' => 'auth.'], function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        // Verify Cellphone
        Route::get('/verification', [PhoneVerificationController::class, 'show'])->name('phone_verification.show');
        Route::post('/verification', [PhoneVerificationController::class, 'verify'])->name('phone_verification.verify');
        Route::post('/verification/resend', [PhoneVerificationController::class, 'resend'])->name('phone_verification.resend');
    });
