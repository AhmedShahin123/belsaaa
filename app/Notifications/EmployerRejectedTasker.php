...
class EmployerRejectedTasker extends Notification
{
    use Queueable;
    ...
    public function toFcm($notifiable)
    {
        return FcmMessage::create()->setNotification(
            \NotificationChannels\Fcm\Resources\Notification::create()
                ->setTitle('تم رفضك من قبل طالب المهمة')
                ->setBody('تم رفضك من قبل طالب المهمة لهذة المهمة')
        )->setData([
            ...
            'event' => 'employer_rejected_tasker',
