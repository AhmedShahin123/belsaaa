...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Application Level Custom Configurations
    |--------------------------------------------------------------------------
    */

    'log_request_details' => env('APP_LOG_REQUEST_DETAILS', false),
    'api_domain' => env('APP_API_DOMAIN', 'api.belsaa.com'),
    'front_domain' => env('APP_FRONT_DOMAIN', 'admin.belsaa.com'),
    'admin_domain' => env('APP_ADMIN_DOMAIN', 'admin.belsaa.com'),
