<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            @guest
{{--                <li class="nav-item"><a href="{{route('admin.login')}}" class="nav-link {{ active_class(Route::is('frontend.auth.login')) }}">@lang('navs.frontend.login')</a></li>--}}
...
{{--                        <a href="{{ route('admin.logout') }}" class="dropdown-item">@lang('navs.general.logout')</a>--}}
                    </div>
                </li>
            @endguest
