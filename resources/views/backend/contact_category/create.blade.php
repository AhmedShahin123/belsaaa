...
@section('title', __('labels.backend.contact_category.management') . ' | ' . __('labels.backend.contact_category.create'))

@section('content')
{{ html()->modelForm($contactCategory, 'POST', route('admin.contact_category.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('labels.backend.contact_category.create')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
