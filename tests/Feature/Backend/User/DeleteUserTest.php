...
class DeleteUserTest extends TestCase
{
    ...
    public function an_admin_can_access_deleted_users_page()
    {
        ...
        $response = $this->get('https://admin.belsaa.com/auth/user/deleted');
    ...
    public function a_user_must_be_soft_deleted_before_permanently_deleted()
    {
        ...
        $response = $this->get("https://admin.belsaa.com/auth/user/{$user->id}/delete");
    ...
    public function an_admin_can_restore_users()
    {
        ...
        $response = $this->get("https://admin.belsaa.com/auth/user/{$user->id}/restore");
    ...
    public function a_user_can_be_deleted()
    {
        ...
        $response = $this->delete("https://admin.belsaa.com/auth/user/{$user->id}");
