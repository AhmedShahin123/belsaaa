...
class UpdateUserTest extends TestCase
{
    ...
    public function an_admin_can_access_the_edit_user_page()
    {
        ...
        $response = $this->get('https://admin.belsaa.com/auth/user/'.$user->id.'/edit');
    ...
    public function an_admin_can_resend_users_confirmation_email()
    {
        ...
        $this->get("https://admin.belsaa.com/auth/user/{$user->id}/account/confirm/resend");
    ...
    public function a_user_can_be_updated()
    {
        ...
        $this->patch("https://admin.belsaa.com/auth/user/{$user->id}", [
            'first_name' => 'John',
            'last_name' => 'Doe',
