...
class ConfirmUserTest extends TestCase
{
    ...
    public function an_admin_can_confirm_a_user()
    {
        ...
        $response = $this->get("https://admin.belsaa.com/auth/user/{$user->id}/confirm");
    ...
    public function a_newly_confirmed_user_gets_notified_when_approved()
    {
        ...
        $this->get("https://admin.belsaa.com/auth/user/{$user->id}/confirm");
    ...
    public function an_admin_can_unconfirm_a_user()
    {
        ...
        $response = $this->get("https://admin.belsaa.com/auth/user/{$user->id}/unconfirm");
    ...
    public function an_admin_cannot_be_unconfirmed()
    {
        ...
        $response = $this->get("https://admin.belsaa.com/auth/user/{$admin->id}/unconfirm");
    ...
    public function a_user_cannot_unconfirm_self()
    {
        ...
        $response = $this->get("https://admin.belsaa.com/auth/user/{$second_admin->id}/unconfirm");
    ...
    public function an_admin_can_unconfirm_a_deleted_user()
    {
        ...
        $this->get("https://admin.belsaa.com/auth/user/{$user->id}/unconfirm");
