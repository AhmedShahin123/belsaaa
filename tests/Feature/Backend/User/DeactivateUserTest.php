...
class DeactivateUserTest extends TestCase
{
    ...
    public function an_admin_can_access_deactivated_users_page()
    {
        ...
        $response = $this->get('https://admin.belsaa.com/auth/user/deactivated');
    ...
    public function an_admin_can_deactivate_users()
    {
        ...
        $this->get("https://admin.belsaa.com/auth/user/{$user->id}/mark/0");
    ...
    public function an_admin_can_reactivate_users()
    {
        ...
        $this->get("https://admin.belsaa.com/auth/user/{$user->id}/mark/1");
    ...
    public function an_admin_cant_deactivate_himself()
    {
        ...
        $response = $this
            ...
            ->get("https://admin.belsaa.com/auth/user/{$admin->id}/mark/0");
